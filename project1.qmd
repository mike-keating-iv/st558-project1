...
edu01a <- read_csv("data/EDU01a.csv", col_select = c(Area_name, STCOU, ends_with("D"))) |>
  rename(
    area_name = Area_name
  )
...
-   Hint: Check out the substr() function from base r
    ...
    edu01a_long <- edu01a_long |> mutate(year = as.numeric(substr(EDU_D, 8,9)), measurement = substr(EDU_D, 1,7)) |> 
